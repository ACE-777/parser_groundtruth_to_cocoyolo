...
path_to_datasets_for_warmup = str("C:\\Users\\misha\\golf-trajectory_project\\stabil_11_14\\stabil_11_14\\stabil_11_14")  # path to stabil_11_14
...
for dir_name in range(len(dir_of_videos_list)):
    ...
    for i in range(len(img_list)-2):
        ...
        destination_path_for_img = os.path.join("C:\\Users\\misha\\train_data\\images\\train",
                                        str(path_dir.stem.split(".")[0]) + "_" + str(img_list[i]))
        shutil.move(image, destination_path_for_img)

        file_with_annotation = open(os.path.join("C:\\Users\\misha\\train_data\\labels\\train",
